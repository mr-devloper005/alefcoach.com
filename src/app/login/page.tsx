...
function getLoginConfig(kind: ReturnType<typeof getProductKind>) {
  ...
  if (kind === 'editorial') {
    return {
      ...
      icon: FileText,
      title: 'Welcome back to your reading workspace',
      body: 'Sign in to sync bookmarks and drafts. Your session is stored locally in this browser for a fast return.',
    }
  }
  if (kind === 'visual') {
    return {
